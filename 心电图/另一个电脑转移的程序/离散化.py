...
data_train = [E_list[30:230] for E_list in data_train]
data_test = [E_list[30:230] for E_list in data_test]
...
class BPNeuralNetwork:
    ...
    def strat_train(self,train_data=data_train[0:1500],train_lab=data_trainlab[0:1500],test_data=data_test,test_lab=data_testlab,num_in=200,num_h=4,num_out=4,iter=1000,lr=0.1,m=0.1,err=40):
...
for iter in range(10):
    rate = nn.strat_train(data_train[0:1500],data_trainlab[0:1500],data_test,data_testlab,200,4,4,1000,0.1,0.1,40)
    rate_list.append(rate)
print(rate_list,sum(rate_list)/10)


# rf_bo = BayesianOptimization(nn.strat_train,{'num_h':(1,10),'err':(1,100)})
# rf_bo.maximize()