...
path_train = r'C:\Users\666\Documents\MATLAB\MIT_HIT\整理数据\short_train.xlsx'
path_test = r'C:\Users\666\Documents\MATLAB\MIT_HIT\整理数据\short_test.xlsx'
...
path_out =  r'C:\Users\666\Documents\MATLAB\MIT_HIT\整理数据\out.xlsx'
...
class BPNeuralNetwork:
    ...
    def strat_train(self,train_data,train_lab,test_data,test_lab,num_in,num_h,num_out,iter,lr,m,err):
        ...
        for i in range(len(test_lab)):
            if tem[i].index(max(tem[i])) == test_lab[i].index(max(test_lab[i])):
                tem[i].append(1)
                num = num+1
            else:
                tem[i].append(0)
...
nn = BPNeuralNetwork()
nn.strat_train(data_train,data_trainlab,data_test,data_testlab,260,8,4,1000,0.1,0.1,50)